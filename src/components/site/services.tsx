      ...
      <div className="shell grid gap-14 lg:grid-cols-12 lg:gap-16">
        <div className="lg:col-span-5">
          <Reveal>
            ...
            <h2 className="display-lg mt-6 text-balance">Reliable Gold Pawning Services, Made Simple</h2>
          ...
          <Reveal delay={0.15}>
            <img src="/images/services-bg.svg" alt="Gold purity being tested" width={1280} height={960} loading="lazy" className="mt-10 aspect-4/3 w-full rounded-sm border border-hairline object-cover" />
          </Reveal>
        </div>
        ...
        <motion.ul variants={staggerParent} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} className="grid gap-4 sm:grid-cols-2 lg:col-span-6 lg:col-start-7 lg:gap-5">
          {SERVICES.map((s) => {
            ...
            return (
              <motion.li key={s.title} variants={staggerChild} className="group relative flex flex-col justify-between overflow-hidden rounded-sm border border-hairline bg-card p-7 transition-colors duration-500 hover:border-foreground/40 md:p-8">
