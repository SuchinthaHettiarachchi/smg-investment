...
export function About() {
  return (
    <section id="about" className="section-padding hairline-t">
      <div className="shell grid gap-8 lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-5">
          ...
          <Reveal delay={0.15} className="mt-6">
            <img src="/images/Image2.webp" alt="Quiet consultation room with secure deposit lockers" width={1104} height={1408} loading="lazy" className="aspect-4/5 w-full rounded-sm border border-hairline object-cover" />
          </Reveal>
        </div>
            ...
            <dl className="hairline-t mt-8 grid grid-cols-2 gap-x-8 gap-y-4 pt-6 sm:grid-cols-3">
              {[
                ...
                <div key={i.k}>
                  ...
                  <dd className="mt-1 font-display text-2xl leading-tight">{i.v}</dd>
                </div>
              ))}
            </dl>
          </Reveal>
